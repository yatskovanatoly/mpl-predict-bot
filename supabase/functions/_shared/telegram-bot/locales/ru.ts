...
others_rounds = 👥 прогнозы игроков
upcoming_percentages = 📈 проценты прогнозов
choose_round = выбери тур:
choose_user = выбери игрока:
no_rounds_with_predictions = пока нет туров с прогнозами
no_users_for_round = в этом туре нет прогнозов других игроков
no_predictions_for_round = прогнозы за этот тур не найдены
round_predictions = 📋 прогнозы на {$n}-й тур
user_round_predictions = 👤 {$name}, {$n}-й тур
