...
const getCheerio = async (round) => {
    const response = await axios.get(`https://${BASE_URL}/championships/${MPL_ID}/games` +
...
export const getRounds = async (round) => {
    const rounds = [];
    let currentRound;
...
//# sourceMappingURL=harvest-data.js.map